...
bool matlab_ge_vec_test(int s1, int s2, bool accuracy_check)
{
    bool success = true;
    ...
    function_comparison_MM("matlab_ge", matlab_geM_ref, matlab_geM_vec, int_matrix1, int_matrix2, notes, accuracy_check, &success);
    function_comparison_MM("matlab_ge", matlab_geM_ref, matlab_geM_vec, int_matrix1, double_matrix1, notes, accuracy_check, &success);
    function_comparison_MM("matlab_ge", matlab_geM_ref, matlab_geM_vec, int_matrix1, complex_matrix1, notes, accuracy_check, &success);

    function_comparison_MM("matlab_ge", matlab_geM_ref, matlab_geM_vec, double_matrix1, int_matrix1, notes, accuracy_check, &success);
    function_comparison_MM("matlab_ge", matlab_geM_ref, matlab_geM_vec, double_matrix1, double_matrix2, notes, accuracy_check, &success);
    function_comparison_MM("matlab_ge", matlab_geM_ref, matlab_geM_vec, double_matrix1, complex_matrix1, notes, accuracy_check, &success);

    function_comparison_MM("matlab_ge", matlab_geM_ref, matlab_geM_vec, complex_matrix1, int_matrix1, notes, accuracy_check, &success);
    function_comparison_MM("matlab_ge", matlab_geM_ref, matlab_geM_vec, complex_matrix1, double_matrix1, notes, accuracy_check, &success);
    function_comparison_MM("matlab_ge", matlab_geM_ref, matlab_geM_vec, complex_matrix1, complex_matrix2, notes, accuracy_check, &success);
...
{
    char *comment="Normal";
    return(run_test(argc, argv, matlab_ge_vec_test,"matlab_geM", MATRIX_MATRIX, comment));
}
