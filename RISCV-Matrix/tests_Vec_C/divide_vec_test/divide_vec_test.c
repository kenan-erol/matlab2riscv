...
bool rdivide_vec_test(int s1, int s2, bool accuracy_check)
{
    bool success = true;
    ...
    // Create an int matrix (of twos)
    Matrix *int_matrix = onesM(ndim, dim);
    int two = 2;
    Matrix *int_matrix1 = scaleM(int_matrix, &two, INTEGER);
    ...
    function_comparison_MM("rdivide", rdivideM_ref, rdivideM_vec, int_matrix1, int_matrix2, notes, accuracy_check, &success);
    function_comparison_MM("rdivide", rdivideM_ref, rdivideM_vec, int_matrix1, double_matrix1, notes, accuracy_check, &success);
    function_comparison_MM("rdivide", rdivideM_ref, rdivideM_vec, int_matrix1, complex_matrix1, notes, accuracy_check, &success);

    function_comparison_MM("rdivide", rdivideM_ref, rdivideM_vec, double_matrix1, int_matrix1, notes, accuracy_check, &success);
    function_comparison_MM("rdivide", rdivideM_ref, rdivideM_vec, double_matrix1, double_matrix2, notes, accuracy_check, &success);
    function_comparison_MM("rdivide", rdivideM_ref, rdivideM_vec, double_matrix1, complex_matrix1, notes, accuracy_check, &success);

    function_comparison_MM("rdivide", rdivideM_ref, rdivideM_vec, complex_matrix1, int_matrix1, notes, accuracy_check, &success);
    function_comparison_MM("rdivide", rdivideM_ref, rdivideM_vec, complex_matrix1, double_matrix1, notes, accuracy_check, &success);
    function_comparison_MM("rdivide", rdivideM_ref, rdivideM_vec, complex_matrix1, complex_matrix2, notes, accuracy_check, &success);
...
{
    char *comment="Normal";
    return(run_test(argc, argv, rdivide_vec_test,"rdivideM", MATRIX_MATRIX, comment));
}
