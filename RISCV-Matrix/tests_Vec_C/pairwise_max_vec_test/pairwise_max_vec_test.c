...
bool pairwise_max_vec_test(int s1, int s2, bool accuracy_check)
{
    bool success = true;
    ...
    function_comparison_MM("pairwise_max", pairwise_maxM_ref, pairwise_maxM_vec, int_matrix1, int_matrix2, notes, accuracy_check, &success);
    function_comparison_MM("pairwise_max", pairwise_maxM_ref, pairwise_maxM_vec, int_matrix1, double_matrix1, notes, accuracy_check, &success);
    function_comparison_MM("pairwise_max", pairwise_maxM_ref, pairwise_maxM_vec, int_matrix1, complex_matrix1, notes, accuracy_check, &success);

    function_comparison_MM("pairwise_max", pairwise_maxM_ref, pairwise_maxM_vec, double_matrix1, int_matrix1, notes, accuracy_check, &success);
    function_comparison_MM("pairwise_max", pairwise_maxM_ref, pairwise_maxM_vec, double_matrix1, double_matrix2, notes, accuracy_check, &success);
    function_comparison_MM("pairwise_max", pairwise_maxM_ref, pairwise_maxM_vec, double_matrix1, complex_matrix1, notes, accuracy_check, &success);

    function_comparison_MM("pairwise_max", pairwise_maxM_ref, pairwise_maxM_vec, complex_matrix1, int_matrix1, notes, accuracy_check, &success);
    function_comparison_MM("pairwise_max", pairwise_maxM_ref, pairwise_maxM_vec, complex_matrix1, double_matrix1, notes, accuracy_check, &success);
    function_comparison_MM("pairwise_max", pairwise_maxM_ref, pairwise_maxM_vec, complex_matrix1, complex_matrix2, notes, accuracy_check, &success);
...
{
    char *comment="Normal";
    return(run_test(argc, argv, pairwise_max_vec_test,"pairwise_maxM", MATRIX_MATRIX, comment));
}
