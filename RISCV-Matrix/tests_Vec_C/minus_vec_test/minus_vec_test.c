...
bool minus_vec_test(int s1, int s2, bool accuracy_check)
{
    bool success = true;
    ...
    function_comparison_MM("minus", minusM_ref, minusM_vec, int_matrix1, int_matrix2, notes, accuracy_check, &success);
    function_comparison_MM("minus", minusM_ref, minusM_vec, int_matrix1, double_matrix1, notes, accuracy_check, &success);
    function_comparison_MM("minus", minusM_ref, minusM_vec, int_matrix1, complex_matrix1, notes, accuracy_check, &success);

    function_comparison_MM("minus", minusM_ref, minusM_vec, double_matrix1, int_matrix1, notes, accuracy_check, &success);
    function_comparison_MM("minus", minusM_ref, minusM_vec, double_matrix1, double_matrix2, notes, accuracy_check, &success);
    function_comparison_MM("minus", minusM_ref, minusM_vec, double_matrix1, complex_matrix1, notes, accuracy_check, &success);

    function_comparison_MM("minus", minusM_ref, minusM_vec, complex_matrix1, int_matrix1, notes, accuracy_check, &success);
    function_comparison_MM("minus", minusM_ref, minusM_vec, complex_matrix1, double_matrix1, notes, accuracy_check, &success);
    function_comparison_MM("minus", minusM_ref, minusM_vec, complex_matrix1, complex_matrix2, notes, accuracy_check, &success);
...
bool minus_vec_test_overflow(int s1, int s2, bool accuracy_check)
{
    bool success = true;
    ...
    if(!accuracy_check){print_table_size(s1, s2);}
    function_comparison_MM("minus", minusM_ref, minusM_vec, int_matrix3, int_matrix2, overflow, accuracy_check, &success);
    if(!accuracy_check){print_table_newline();}

    if(!accuracy_check){print_table_size(s1, s2);}
    function_comparison_MM("minus", minusM_ref, minusM_vec, int_matrix4, int_matrix2, overflow, accuracy_check, &success);
    if(!accuracy_check){print_table_newline();}
...
int main(int argc, char *argv[]) 
{
    ...
    char *comment="Normal";
    if(!run_test(argc, argv, minus_vec_test,"minusM", MATRIX_MATRIX, comment)){success = false;}

    comment = "Overflow";
    if(!run_test(argc, argv, minus_vec_test_overflow,"minusM", MATRIX_MATRIX, comment)){success = false;}
