...
bool octave_le_vec_test(int s1, int s2, bool accuracy_check)
{
    bool success = true;
    ...
    function_comparison_MM("octave_le", octave_leM_ref, octave_leM_vec, int_matrix1, int_matrix2, notes, accuracy_check, &success);
    function_comparison_MM("octave_le", octave_leM_ref, octave_leM_vec, int_matrix1, double_matrix1, notes, accuracy_check, &success);
    function_comparison_MM("octave_le", octave_leM_ref, octave_leM_vec, int_matrix1, complex_matrix1, notes, accuracy_check, &success);

    function_comparison_MM("octave_le", octave_leM_ref, octave_leM_vec, double_matrix1, int_matrix1, notes, accuracy_check, &success);
    function_comparison_MM("octave_le", octave_leM_ref, octave_leM_vec, double_matrix1, double_matrix2, notes, accuracy_check, &success);
    function_comparison_MM("octave_le", octave_leM_ref, octave_leM_vec, double_matrix1, complex_matrix1, notes, accuracy_check, &success);

    function_comparison_MM("octave_le", octave_leM_ref, octave_leM_vec, complex_matrix1, int_matrix1, notes, accuracy_check, &success);
    function_comparison_MM("octave_le", octave_leM_ref, octave_leM_vec, complex_matrix1, double_matrix1, notes, accuracy_check, &success);
    function_comparison_MM("octave_le", octave_leM_ref, octave_leM_vec, complex_matrix1, complex_matrix2, notes, accuracy_check, &success);
...
{
    char *comment="Normal";
    return(run_test(argc, argv, octave_le_vec_test,"octave_leM", MATRIX_MATRIX, comment));
}
