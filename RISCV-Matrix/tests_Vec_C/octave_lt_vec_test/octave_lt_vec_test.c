...
bool octave_lt_vec_test(int s1, int s2, bool accuracy_check)
{
    bool success = true;
    ...
    function_comparison_MM("octave_lt", octave_ltM_ref, octave_ltM_vec, int_matrix1, int_matrix2, notes, accuracy_check, &success);
    function_comparison_MM("octave_lt", octave_ltM_ref, octave_ltM_vec, int_matrix1, double_matrix1, notes, accuracy_check, &success);
    function_comparison_MM("octave_lt", octave_ltM_ref, octave_ltM_vec, int_matrix1, complex_matrix1, notes, accuracy_check, &success);

    function_comparison_MM("octave_lt", octave_ltM_ref, octave_ltM_vec, double_matrix1, int_matrix1, notes, accuracy_check, &success);
    function_comparison_MM("octave_lt", octave_ltM_ref, octave_ltM_vec, double_matrix1, double_matrix2, notes, accuracy_check, &success);
    function_comparison_MM("octave_lt", octave_ltM_ref, octave_ltM_vec, double_matrix1, complex_matrix1, notes, accuracy_check, &success);

    function_comparison_MM("octave_lt", octave_ltM_ref, octave_ltM_vec, complex_matrix1, int_matrix1, notes, accuracy_check, &success);
    function_comparison_MM("octave_lt", octave_ltM_ref, octave_ltM_vec, complex_matrix1, double_matrix1, notes, accuracy_check, &success);
    function_comparison_MM("octave_lt", octave_ltM_ref, octave_ltM_vec, complex_matrix1, complex_matrix2, notes, accuracy_check, &success);
...
{
    char *comment="Normal";
    return(run_test(argc, argv, octave_lt_vec_test,"octave_ltM", MATRIX_MATRIX, comment));
}
