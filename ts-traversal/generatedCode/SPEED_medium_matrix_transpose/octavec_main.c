//
//  SPEED_medium_matrix_transpose.c
//  Octave-C
//
...
// Speedtest: Transpose a medium-sized double matrix
int main() 
{
	bool flag = true;
	...
	int iterations = 100;
	Matrix **transposes = NULL;
	transposes = malloc(iterations*sizeof(*transposes));

	// Get the eigenvalues and vectors of the matrix
	for (int i = 0 ; i < iterations ; i++)
	{
		transposes[i] = transposeM(tmp);
	}
