...
addpath('/home/dlg59/project/ts-traversal/generatedCode/3d_index_matrix/matlabToRun');
fileID = fopen('/home/dlg59/project/ts-traversal/generatedCode/3d_index_matrix/output.txt','w');
%more off
%format short
