%% STYLE: HOOK + EXPLICIT THESIS.
%% The EDST paper opens with Chris D'Agata's "relatively civilized,
%% relatively European" quote -- one concrete utterance that frames the
%% whole argument. The survey-style opener below lacks that anchor.
%% Replace with something concrete, e.g.:
%%   "A sliver of silicon sealed under the dura of a rat with
%%   pharmacoresistant epilepsy has fifteen milliwatts to listen to a
%%   hundred channels of neural signal, decide whether a seizure is
%%   coming, and stimulate back -- all without warming the cortex by
%%   more than one degree Celsius \cite{10120914}."
%% Then state the thesis in the same declarative voice you used for
%% "I will argue that race and ethnicity are the primary determinants..."
%%   "I argue that the toolchain -- not the silicon -- is the current
%%   bottleneck in making that 15 mW budget usable by the neuroscientists
%%   who write the algorithms, and that open-source compiler evolution
%%   has quietly reshaped what counts as a good RVV kernel."
